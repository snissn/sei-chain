...
func (kves *EventSink) IndexTxEventsWithHashes(results []*abci.TxResultV2, txHashes []types.TxHash) error {
	return kves.txi.IndexWithVerifiedHashes(results, txHashes)
}
